...
import com.eknv.turbo.security.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
          ...
          //todo/kn.. make the following two lines profile dependent (dev vs prod)
            ...
            .antMatchers("/action/maintenance").permitAll()
            .antMatchers("/api/paction").permitAll()

            // todo/kn.. the following lines should be authenticated later
            .antMatchers("/api/action").permitAll()
            .antMatchers("/api/jsaction").permitAll()
